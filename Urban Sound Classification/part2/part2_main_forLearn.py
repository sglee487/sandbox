        ...
        for fn in glob.glob(os.path.join(parent_dir, sub_dir, file_ext)):
            ...
            for (start, end) in windows(sound_clip, window_size):
                if (len(sound_clip[start:end]) == window_size):
                    ...
                    melspec = librosa.feature.melspectrogram(signal, n_mels=bands) # https://librosa.github.io/librosa/generated/librosa.feature.melspectrogram.html
                    ...
                    logspec = librosa.core.amplitude_to_db(melspec) # https://librosa.github.io/librosa/generated/librosa.core.amplitude_to_db.html
